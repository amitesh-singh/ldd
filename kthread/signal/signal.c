...
thread_function(void *data)
{
   ...
   // this will respect kill -9 <thread_id> request and stop this thread,
   // Also when you do rmmod <kernl thread module>, it will gracefully exit
   // without any delay/blocking
