...
#define MY_USB_PRODUCT_ID 0x16c0
#define MY_USB_VENDOR_ID 0x05dc

//refer this article for more details: http://opensourceforu.com/2011/11/usb-drivers-in-linux-2/
             ...
             const struct usb_device_id *id)
{
   ...
   //container device handle, interface_to_usbdev is a macro
...
{
   printk(KERN_INFO "usb device: %d is disconnected", interface->cur_altsetting->desc.bInterfaceNumber);
}
